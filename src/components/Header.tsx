...
const Header = () => {
	...
	return (
		<header className="sm:px-4 reltive fixed inset-x-0 z-100" ref={menuRef}>
			<div className="flex items-center justify-between max-w-350 mx-auto bgprimary/75 sm:rounded-[97px] py-6 md:py-8 pr-8 pl-7 sm:pr-16 sm:mt-8.25 max-h-27.5 transition-all duration-300 frost-bg">
				{/* Logo */}
					...
					<ul className="flex flex-col px-4 py-3">
						{["program", "timeline"].map((item, i) => (
							...
							>
								...
								{i < 3 && <div className="h-px bg-gray-100 mx-3" />}
							</li>
						))}
